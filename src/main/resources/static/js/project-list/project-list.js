...
// helpText에 'body-1'과 'text700' 클래스를 추가
helpText.classList.add("body-1", "text700");

// checkProject라는 클래스명을 가진 div의 개수를 카운트
const projectDivs = document.querySelectorAll(".project-info-box");
const projectCount = projectDivs.length;

// helpText의 텍스트를 설정
helpText.innerText = `${projectCount}개의 프로젝트`;
