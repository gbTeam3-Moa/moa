...
SELECT RP2.ID, RP2.MEMBER_ID, RP2.CREATED_DATE, RP2.POST_TITLE, RP2.POST_VIEW, RP2.REPLY_COUNT, RP2.REPORT_REASON, RP2.REPORT_STATUS
FROM (
         SELECT RP1.*, ROWNUM AS R
         FROM (
SELECT RP.ID, M.MEMBER_ID, P.CREATED_DATE, P.POST_TITLE, P.POST_VIEW, COUNT(RE.ID) AS REPLY_COUNT, RP.REPORT_REASON, RP.REPORT_STATUS
FROM TBL_REPORT RP
